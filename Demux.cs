...
namespace Components
{
    ...
    class Demux : Gate
    {
        ...
        public Demux()
        {
            ...
            m_gAnd1.ConnectInput2(Control);
            m_gNot.ConnectInput(Control);
            m_gAnd2.ConnectInput2(m_gNot.Output);
            m_gAnd2.ConnectInput1(Input);
            Output1 = m_gAnd2.Output;
            Output2 = m_gAnd1.Output;
        ...
        {
            return "DeMux " + Input.Value + "," + Control.Value + "-> Output1: " + Output1.Value + " Output2: " + Output2.Value;
        }
